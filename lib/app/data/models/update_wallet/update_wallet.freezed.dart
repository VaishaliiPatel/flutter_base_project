...
UpdateWalletModel _$UpdateWalletModelFromJson(Map<String, dynamic> json) {
  return _UpdateWalletModel.fromJson(json);
}

/// @nodoc
mixin _$UpdateWalletModel {
  ...
  @JsonKey(ignore: true)
  $UpdateWalletModelCopyWith<UpdateWalletModel> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $UpdateWalletModelCopyWith<$Res> {
  factory $UpdateWalletModelCopyWith(
          UpdateWalletModel value, $Res Function(UpdateWalletModel) then) =
      _$UpdateWalletModelCopyWithImpl<$Res, UpdateWalletModel>;
  @useResult
  $Res call(
      {int? status,
      String? message,
...
/// @nodoc
class _$UpdateWalletModelCopyWithImpl<$Res, $Val extends UpdateWalletModel>
    implements $UpdateWalletModelCopyWith<$Res> {
  _$UpdateWalletModelCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$_UpdateWalletModelCopyWith<$Res>
    implements $UpdateWalletModelCopyWith<$Res> {
  factory _$$_UpdateWalletModelCopyWith(_$_UpdateWalletModel value,
          $Res Function(_$_UpdateWalletModel) then) =
      __$$_UpdateWalletModelCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {int? status,
...
/// @nodoc
class __$$_UpdateWalletModelCopyWithImpl<$Res>
    extends _$UpdateWalletModelCopyWithImpl<$Res, _$_UpdateWalletModel>
    implements _$$_UpdateWalletModelCopyWith<$Res> {
  __$$_UpdateWalletModelCopyWithImpl(
      _$_UpdateWalletModel _value, $Res Function(_$_UpdateWalletModel) _then)
      : super(_value, _then);
  ...
  $Res call({
    ...
    return _then(_$_UpdateWalletModel(
      status: freezed == status
          ? _value.status
          : status // ignore: cast_nullable_to_non_nullable
              as int?,
...
/// @nodoc
@JsonSerializable()
class _$_UpdateWalletModel implements _UpdateWalletModel {
  const _$_UpdateWalletModel(
      {this.status, this.message, this.data, this.validationError});

  factory _$_UpdateWalletModel.fromJson(Map<String, dynamic> json) =>
      _$$_UpdateWalletModelFromJson(json);
  ...
  @override
  String toString() {
    return 'UpdateWalletModel(status: $status, message: $message, data: $data, validationError: $validationError)';
  }
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$_UpdateWalletModelCopyWith<_$_UpdateWalletModel> get copyWith =>
      __$$_UpdateWalletModelCopyWithImpl<_$_UpdateWalletModel>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$_UpdateWalletModelToJson(
      this,
    );
  }
}

abstract class _UpdateWalletModel implements UpdateWalletModel {
  const factory _UpdateWalletModel(
      {final int? status,
      final String? message,
      final Data? data,
      final ValidationError? validationError}) = _$_UpdateWalletModel;

  factory _UpdateWalletModel.fromJson(Map<String, dynamic> json) =
      _$_UpdateWalletModel.fromJson;
