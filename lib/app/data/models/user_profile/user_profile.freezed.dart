...
class _$_UserProfile implements _UserProfile {
  ...
  @override
  String toString() {
    return 'UserProfile(status: $status, message: $message, data: $data, validationError: $validationError)';
  }
...
abstract class _UserProfile implements UserProfile {
  const factory _UserProfile(
      ...
      final String? message,
      final Data? data,
      final ValidationError? validationError}) = _$_UserProfile;
...
class _$_Data implements _Data {
  ...
  @override
  String toString() {
    return 'Data(userPk: $userPk, firstName: $firstName, lastName: $lastName, access: $access, mobileNo: $mobileNo, email: $email, countryCode: $countryCode, userImage: $userImage, address: $address, city: $city, state: $state, country: $country, pincode: $pincode)';
  }
