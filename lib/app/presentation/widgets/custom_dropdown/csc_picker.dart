...
import 'package:cmsocpp/app/data/models/custom_dropdown/select_status_model.dart';
...
class CSCPicker extends StatefulWidget {
  ...
  final TextStyle? selectedItemStyle, dropdownHeadingStyle, dropdownItemStyle, headerStyle;
...
class CSCPickerState extends State<CSCPicker> {
  ...
  Future<void> setDefaults() async {
    ...
    widget.profileController.isLoading.value = false;
  }

  void _setDefaultCountry() {
    if (widget.defaultCountry != null) {
      printLog(_country[defaultCountries[widget.defaultCountry]!]);
  ...
  Future<List<String?>> getStates() async {
    ...
    if (_states.isEmpty && widget.isShowAddressToast) {
      CommonMethods.showSnackBarInfo(StringConfig.emptyStateText, StringConfig.addressText);
    }
    return _states;
  }
  ...
  Future<List<String?>> getCities() async {
    ...
    if (_cities.isEmpty && widget.isShowAddressToast) {
      CommonMethods.showSnackBarInfo(StringConfig.emptyCityText, StringConfig.addressText);
    }
    return _cities;
  }
  ...
  Widget countryDropdown() {
    return DropdownWithSearch(
      ...
      onChanged: (value) {
        printLog("countryChanged $value $_selectedCountry");
        if (value != null) {
