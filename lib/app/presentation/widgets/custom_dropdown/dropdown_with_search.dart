            ...
            children: [
              Expanded(
                  child: Text(selected.toString(),
                      ...
                      style: selectedItemStyle ?? TextStyle(fontSize: 14.sp))),
              Icon(
...
class SearchDialog extends StatefulWidget {
  ...
  final double? dialogRadius;
  final TextStyle? popupHeaderStyle;
  final Color popupBgColor;
    ...
    textController.addListener(() {
      setState(() {
        if (textController.text.isEmpty) {
          ...
          filteredList = widget.items
              .where((element) => element.toString().toLowerCase().contains(textController.text.toLowerCase()))
              .toList();
        }
      });
    });
  ...
  Widget build(BuildContext context) {
    return CustomDialog(
      shape: RoundedRectangleBorder(
          borderRadius:
              widget.dialogRadius != null ? BorderRadius.circular(widget.dialogRadius!) : BorderRadius.circular(12)),
      child: ClipRRect(
        borderRadius: BorderRadius.circular(12.r),
        child: Container(
          color: widget.popupBgColor,
          child: Column(
              ...
              Row(
                ...
                children: [
                  Container(
                    ...
                    child: Text(
                      widget.title,
                      style: widget.titleStyle ?? TextStyle(fontSize: 16.sp, fontWeight: FontWeight.w500),
                    ),
                  ),
                  IconButton(
              ...
              Container(
                ...
                child: TextField(
                  ...
                  decoration: InputDecoration(
                    isDense: true,
                    prefixIcon: const Icon(Icons.search,color: ColorConfig.primaryColor,),
              ...
              Expanded(
                child: ClipRRect(
                  borderRadius: BorderRadius.all(
                      widget.dialogRadius != null ? Radius.circular(widget.dialogRadius!) : Radius.circular(5.r)),
